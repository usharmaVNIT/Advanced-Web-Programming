	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="../Introduction.html#contact" class="nav-link">Contact</a></li>
                  ...
                  <li class="nav-item"><a href="../HotelWelcomeNotRegistered.jsp" class="nav-link">Logout</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
          ...
          if(yo>=yi){
              if(mo>=mi){
                  if(doo>=di){
                      ...
                      alert("Check in Date is Greator Than Check out Date");
                  }
              }else{
                  alert("Check in Date is Less Greator Check out Date");
              }
          }else{
              alert("Check in Date is Less Greator Check out Date");
          }
