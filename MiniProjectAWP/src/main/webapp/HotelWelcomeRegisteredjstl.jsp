...
<link href="CSS/hotelcards.css" rel="stylesheet" type="text/css"/>
  ...
  <sql:setDataSource var="db" driver="com.mysql.jdbc.Driver" url="jdbc:mysql://localhost:3306/MiniProject"
            ...
            <sql:query dataSource="${db}" var="rs">
                SELECT * from MiniProject.Hotels
            </sql:query>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Feedback/Feedback.html">Feed Back</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
          <li><a href="#"><span class="glyphicon glyphicon-user"></span>${sessionScope["username"]}</a></li>
          <li><a href="HotelWelcomeNotRegistered.jsp"><span class="glyphicon glyphicon-user"></span>Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
        ...
        <div class ="maindiv">
         <c:forEach var="table" items="${rs.rows}">
                <div class="Hotel-card">
                    <div class="Hotel-header" style="background : url('HotelImages/${table.imageid}.jpeg');background-repeat: no-repeat;background-size: cover;
                         background-position: center;">
                    </div>
                    <div class="Hotel-content">
                        <div class="Hotel-content-header">
                            <h3 class="Hotel-title" align="center"><a href="HotelBooking/HotelBooking.jsp?hotelname=${table.Name}&imageid=${table.imageid}&luxury=${table.Luxury}&semi=${table.SemiLuxury}&normal=${table.Normal}">${table.Name}</a></h3>
                        </div>
         ...
         type = "number" value = "${(table.Luxury + table.Semi-Luxury + table.Normal)/3}" />
                            <span> ${i} Rs.</span>
                        </div>
                        </div>
                    </div>
